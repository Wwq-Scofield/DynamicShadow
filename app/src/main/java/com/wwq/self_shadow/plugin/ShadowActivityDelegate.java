...
import static com.wwq.self_shadow.MainActivity.baseDexClassLoader;
    ...
    public void onCreate(Bundle arg0) {
        Log.d("shadow_ca", "onCreate...");
        try {
            mMixResources = new MixResources(mHostActivityDelegator.superGetResources(), mPluginResources);
            mDependenciesInjected=true;
            Object o1 = baseDexClassLoader.loadClass("com.wwq.shadow_demo.MainActivity").newInstance();
...
//            service.onCreate();
            ...
            Log.d("shadow_ca", "onCreate...shadowActivity ="+shadowActivity);
            ...
            shadowActivity.setApplicationInfo(MainActivity.applicationInfo);
            shadowActivity.setHostContextAsBase((Context) mHostActivityDelegator.getHostActivity());

            super.pluginActivity = shadowActivity;
            shadowActivity.setTheme(MainActivity.applicationInfo.theme);
